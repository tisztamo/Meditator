// End-to-end test of the site's LIVE mode against a running Meditator:
//   1. start `bun run meditator.js` (any architecture with m-ws on 7627)
//   2. bun architecture/tests/test-site-live.js
