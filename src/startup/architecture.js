...
async function getArchitectureFilePath() {
  ...
  const defaultPath = "architecture/awake.archml"; // Default architecture file path, relative to the project root.
                                                     // archml is architecture markup language, a subset of HTML
