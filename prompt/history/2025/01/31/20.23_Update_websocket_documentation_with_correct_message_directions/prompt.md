...
Improve the documentation!
 ...
 Update the websocket documentation:  Error handling should be renamed to  incoming messages, and the other ones under Message Types are outgoing.
